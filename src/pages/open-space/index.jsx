    ...
    <div className="w-full h-auto bg-[#EBEBEB]  ">
      ...
      >
        <h2
          ...
          className=" lg:text-[70px] w-[75%] sm:text-[30px]  sm:pt-[180px]  sm:leading-[40px] text-white text-[100px]  pt-[320px] leading-[100px]"
        >
      ...
      <div className="flex w-full h-[60vh] pb-20 pt-32 sm:mt-28 bg-[#EBEBEB]">
        <div className=" flex sm:flex-col-reverse w-screen px-14 sm:px-5 ">
          <h3
            data-aos="fade-right"
            className="text-[32px] w-[40%] sm:w-full text-[#2D2D2D]"
          >
            Membership
          </h3>
          <div className="w-[60%] sm:w-full">
            <h2
              data-aos="fade-down"
              className="text-[#8D8D8D] text-[32px] lg:mt-[-280px]"
            >
              120+ Places
            </h2>
            <p
              data-aos="zoom-in"
              className="text-[20px] text-[#2D2D2D] mt-8 w-[45%] sm:w-full "
            >
              Our co-working environment is more than just shared desks. It's a
              community-driven ecosystem designed to elevate your work
              experience
            </p>
          </div>
        </div>
      ...
      <div
        className={
          "flex w-full h-auto justify-center items-center gap-10 bg-[#EBEBEB] sm:flex-wrap lg:flex-wrap"
        }
      >
        <div
          data-aos="fade-up"
          className="w-[440px] sm:w-[90%] sm:h-auto h-[585px] bg-[#FFFFFF] border rounded-[20px] flex flex-col  p-8"
        >
          <h3 className=" text-[#2D2D2D] mt-4 text-[28px]">Day Plan</h3>
          <h2 className="text-[48px] text-[#2D2D2D] mt-1 sm:text-[28px]">
            70 000 uzs
          ...
          <Link to="/about-studio">
            <button className="   sm:w-[90%] w-[347px] mt-[130px]  ml-3 h-[60px] bg-[#373737] rounded-[90px] text-white text-[19px]  ">
              Booking space
            </button>
          </Link>
        </div>
        <div
          data-aos="fade-up"
          data-aos-delay="300"
          className="w-[440px] sm:w-[90%] sm:h-auto h-[585px] bg-[#D1D1D1] border rounded-[20px] flex flex-col  p-8"
        >
          ...
          <Link to="/about-studio">
            <button className="   sm:w-[90%] w-[347px] mt-[95px]  ml-3 h-[60px] bg-[#373737] rounded-[90px] text-white  text-[19px]  ">
              Booking space
            </button>
          </Link>
        </div>
        <div
          data-aos="fade-up"
          data-aos-delay="600"
          className="w-[440px] sm:w-[90%] sm:h-auto h-[585px] bg-[#2D2D2D] border rounded-[20px] flex flex-col  p-8"
        >
          <h3 className=" text-[#FFFFFF] mt-4 text-[28px]">Fix Plan</h3>
          <h2 className="text-[48px] text-[#FFFFFF] mt-1 sm:text-[28px]">
            2,2 mln uzs{" "}
            <span className="text-[#797979] text-[18px]">/Month</span>
          </h2>
          <div className="mt-8 w-full flex flex-col gap-4">
            <p className="flex items-center gap-2 text-[16px] text-[#797979]">
              <img className="w-[16px] h-[17px]" src={Chek} alt="" />
            ...
            <p className="sm:w-[98%]  flex items-center gap-2 text-[16px] text-[#797979] w-[450px]">
              <img className="  w-[16px] h-[17px]" src={Chek} alt="" />
              Community events and networking opportunites
            </p>
            <p className="flex items-center gap-2 text-[16px] text-[#797979]">
          ...
          <Link to="/about-studio">
            <button className="sm:w-[90%]  mt-[91px] w-[347px]  ml-3 h-[57px] bg-[#DFDFDF] rounded-[90px] text-[#2D2D2D] text-[19px]">
              Booking space
            </button>
          </Link>
        </div>
