    ...
    <div className="w-full h-auto  bg-[#EBEBEB] ">
      ...
      >
        <h2
          ...
          className=" lg:text-[70px] lg:w-[80%] sm:text-[30px]  sm:pt-[180px]  sm:w-[270px]  sm:leading-[40px] text-white text-[100px] w-[955px] pt-[320px] leading-[100px]"
        >
        ...
        <button
          ...
          data-aos-delay="200"
          className={
              "w-[180px] mt-10 sm:w-[160px] sm:text-[13px]  sm:h-[45px] sm:mt-[40px] text-[15px] h-[50px] bg-white rounded-[90px] text-[#2D2D2D]  sm:mb-64"
            }
            >
          BOOKING SPACE
        </button>
      ...
      <div className="flex w-full h-auto pb-20 pt-32 bg-[#EBEBEB]">
        <div
          data-aos="zoom-in"
          className="flex sm:flex-col-reverse  sm:pt-44 w-full justify-between px-14 sm:px-5"
        >
          <h3 className="text-[32px] text-[#2D2D2D] w-[50%] sm:w-full">
            Tariff plan
          </h3>
          <div data-aos="fade-up" className="w-[50%] sm:w-full">
            <h2 className="text-[#8D8D8D] text-[32px] lg:mt-[-280px] ">
              5+ Meeting rooms
            </h2>
            <p className="text-[20px] sm:w-[80%] text-[#2D2D2D] w-[390px] mt-8 ">
              Our meeting rooms blend functionality with sophistication,
              providing the perfect setting for your professional endeavors.
            </p>
          </div>
        </div>
      </div>
      <div className="w-full sm:h-[460vh] flex flex-col py-10 pb-56 gap-20">
        <div className="flex sm:flex-col justify-between px-14 sm:px-5 items-start gap-5">
          <div
            data-aos="zoom-in"
            data-aos-duration="1000"
            className="w-[50%] h-full bg-white rounded-[20px] flex sm:w-full sm:flex sm:flex-col "
          >
            <img
              src={Conference}
              className="w-[40%] sm:w-full sm:rounded-3xl"
              alt=""
            />
            <div
              data-aos="fade-up"
            ...
            >
              ...
              <h2 className="text-[30px] text-[#464646] mt-1 sm:text-[30px]">
                100 000 uzs
                <span className="text-[10px] text-[#464646]  sm:text-[18px]">
                  /Hourse{" "}
                </span>
              </h2>
              <div className="w-[300px] h-[50px] flex gap-1 mt-4">
                <div className="h-[50px] flex flex-col ">
                  <h3 className="flex items-center gap-1 text-[12px] text-[#797979]">
                    <img className="h-[14px]" src={Chek} alt="" />
                    Table
                  </h3>
                  <h3 className="flex items-center gap-1 text-[12px] text-[#797979]">
                    <img className="h-[14px]" src={Chek} alt="" />
                ...
                <div className=" h-[50px] flex flex-col ">
                  ...
                  <h3 className="flex w-[150px] items-center gap-2 text-[10px]  text-[#797979]">
                    <img className="h-[14px]" src={Chek} alt="" />
              ...
              <br />
              <p className={"text-[10px] w-[90%] text-[#797979]"}>
                A professional on-demand office space. Perfect when you need to
                get your head down and do your best work
              </p>
              <Link to="/about-studio">
              <button className="w-[127px] h-[30px] bg-[#373737] rounded-[90px] text-white text-[10px] mt-10">
                BOOKING ROOM
              </button>
              </Link>
            </div>
