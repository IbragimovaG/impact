    ...
    return (
        <div className="w-full h-auto bg-[#EDEDED]">
            ...
            <div
                ...
                <h2 data-aos='fade-right' data-aos-duration='1000' className=" sm:text-[40px]  sm:pt-[180px]  sm:leading-[40px] text-white text-[100px] pt-[320px] leading-[100px] lg:w-full">
                    Welcome to
                    Impact.t Studio
                </h2>
                <button data-aos='fade-right' data-aos-delay='200' data-aos-duration='1000'
                    className={"w-[180px] mt-20 sm:w-[160px] sm:text-[13px]  sm:h-[45px]  sm:mt-[50px] text-[15px] h-[50px] bg-white rounded-[90px] text-[#2D2D2D]  sm:mb-64"}>
                    READ
                </button>
            </div>
            <div className="my-14 pt-14 bg-[#EDEDED]">
                ...
                <div className="flex sm:flex-col justify-between px-12 sm:px-5 gap-20">
                    <div data-aos='zoom-in' className="card w-1/2 sm:w-full bg-no-repeat bg-cover relative flex justify-between text-start flex-col">
            ...
            <div className='w-[100%] flex px-9 justify-between items-start sm:flex-col sm:gap-10 sm:px-5'>
                <div data-aos='zoom-in' className=" w-[30%] bg-no-repeat bg-cover relative sm:w-full mx-auto lg:h-[400px] ">
                    <div className="relative">
                        <img
                ...
                <div data-aos='zoom-in' className=" w-[30%] bg-no-repeat bg-cover relative sm:w-full mx-auto mb-[5%]">
                    <div className="relative">
                        <img
                ...
                <div data-aos='zoom-in' className="w-[30%] bg-no-repeat bg-cover relative sm:w-full mx-auto ">
                    <div className="relative">
                        <img
            ...
            <div className='w-[100%] flex px-9 justify-between items-start pb-32 sm:flex-col sm:gap-10 sm:mt-10 sm:px-5'>
                  <div data-aos='zoom-in' className="w-[30%] bg-no-repeat bg-cover sm:w-full mx-auto ">
                        <div className="relative">
                            <img
