...
function Offece(props) {
    return (
        <div className="w-full h-auto bg-[#EBEBEB]">
            ...
            >
                <h2 data-aos='fade-right' data-aos-duration='1000' className="lg:text-[70px] lg:w-[80%] ml-[50px] sm:ml-[20px] sm:text-[40px] sm:pt-[180px] sm:w-[270px] sm:leading-[40px] text-white text-[100px] w-[955px] pt-[320px]  leading-[100px]">
            ...
            <div className={"w-full flex-wrap gap-1  h-[200vh]  sm:h-auto"}>
                <div data-aos='zoom-in' className="w-[843px] h-[447px] bg-white ml-[490px] rounded-[20px] lg:ml-0 sm:w-[95%] sm:m-auto sm:flex sm:h-[860px] sm:flex-col sm:gap-2 lg:w-full">
                    ...
                    <div className={"ml-[450px] mt-[-420px]  sm:ml-0 sm:mt-0 sm:py-5"}>
                        ...
                        <div className="w-[300px] h-[70px] flex  mt-3 ml-[-20px] sm:w-full sm:ml-0 sm:pl-4">
                            <div className=" gap-4 h-[50px] flex flex-col sm:w-full ">
                                <h3 className="w-[200px] flex items-center gap-2 text-[13px] text-[#797979]"><img
                                    className="w-[12px] h-[12px]" src={Chek1} alt="" />Access 24/7</h3>
                                <h3 className="flex items-center gap-2 text-[13px] text-[#797979]"><img
                                    className="w-[12px] h-[12px]" src={Chek2} alt="" />Communal payments</h3>
                                <h3 className="flex items-center gap-2 text-[13px] text-[#797979]"><img
                                    className="w-[12px] h-[14px]" src={Chek3} alt="" />Use of meeting rooms and
                                    conference rooms</h3>
                            </div>
                            <div className="w-[200px] gap-4 h-[50px] flex flex-col  sm:w-full">
                                <h3 className="w-[200px] flex items-center gap-2 text-[14px] text-[#797979] sm:w-full"><img
                                    className="w-[12px] h-[12px]" src={Chek1} alt="" />High speed internet</h3>
                                <h3 className="flex items-center gap-2 text-[14px] text-[#797979]"><img
                                    className="w-[12px] h-[12px]" src={Chek2} alt="" />Cleaning</h3>
                                <h3 className="flex items-center gap-2 text-[14px] text-[#797979]"><img
                                    className="w-[12px] h-[12px]" src={Chek3} alt="" />Furniture</h3>      <h3
                                        className="flex items-center gap-2 text-[14px] text-[#797979]"><img
                        ...
                        <br />
                        <p className={"text-[12px] w-[300px] ml-[-13px] sm:ml-0 sm:pl-4 text-gray-500"}>A professional on-demand office space. Perfect
                            when you
                ...
                <div data-aos='fade-up' className="w-[843px] h-[447px] bg-white ml-[490px] mt-10 rounded-[20px] lg:ml-0 sm:w-[95%] sm:m-auto sm:mt-10 sm:flex sm:h-[860px] sm:flex-col sm:gap-2 lg:w-full">
                    ...
                    <div className={"ml-[450px] mt-[-400px] sm:ml-0 sm:mt-4 sm:pl-4"}>
                        ...
                        <div className="w-[300px] h-[50px] flex mt-4 ml-[-20px] sm:ml-0 sm:w-full ">
                            ...
                            <br />
                            <div className="w-[200px] gap-4 h-[50px] flex flex-col  sm:w-full">
                                <h3 className="w-[200px] flex items-center gap-2 text-[13px] text-[#797979] sm:w-full"><img
                                    className="w-[12px] h-[12px]" src={Chek1} alt="" />High speed internet</h3>
                                <h3 className="flex items-center gap-2 text-[13px] text-[#797979]"><img
                                    className="w-[12px] h-[12px]" src={Chek2} alt="" />Cleaning</h3>
                                <h3 className="flex items-center gap-2 text-[13px] text-[#797979]"><img
                                    className="w-[12px] h-[12px]" src={Chek3} alt="" />Furniture</h3>      <h3
                                        className="flex items-center gap-2 text-[13px] text-[#797979]"><img
                                        className="w-[12px] h-[12px]" src={Chek3} alt="" />Delicious black coffee 24/7</h3>
                            </div>
                        </div>
                        <div className={"w-auto h-auto flex gap-4 pt-2 ml-[-15px] mt-[80px] sm:pl-4 sm:ml-0 sm:mt-24"}>
                ...
                <div data-aos='fade-up' className="w-[843px] h-[447px] bg-white ml-[490px] mt-10 rounded-[20px] lg:ml-0 sm:w-[95%] sm:m-auto sm:mt-10 sm:flex sm:h-[860px] sm:flex-col sm:gap-2 lg:w-full">
                    ...
                    <div className={"ml-[450px] mt-[-400px] sm:ml-0 sm:mt-4 "}>
                        ...
                        <div className={"w-auto h-auto flex gap-4 pt-2 ml-[-15px] mt-[80px] sm:ml-0 sm:pl-4 sm:mt-24"}>
                            <h2 className={"text-[13px] "}>Impact.t hub</h2>
                            <img src={Pl} alt="" />
