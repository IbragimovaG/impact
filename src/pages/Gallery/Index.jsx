...
export default function Index() {
    return (
        <div>
            <Navbar />
            <div className='h-auto pb-32  container bg-backgroundImageGallery bg-cover bg-no-repeat rounded-none'>
                <h1 data-aos='fade-right' data-aos-duration='1000' className='pt-60 pr-10 text-[95px] sm:text-6xl lg:text-center lg:w-full lg:px-10 sm:w-full sm:px-5 sm:pt-48 sm:text-center pl-14 w-2/3 text-white'>Discover all the
                    highlights we have
                    to offer!</h1>
            </div>
